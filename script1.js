...
document
  .querySelector("#gameSliderButton1")
...
// })
document
  .querySelector("#gameSliderButton2")
  .addEventListener("click", function () {
    slide1.classList.toggle("hiddenContainer");
    slide2.classList.toggle("hiddenContainer");
  });
...
document.querySelector("#show_more1").addEventListener("click", function () {
  if (count == 1) {
    ...
    document.querySelector("#show_more2").innerHTML =
      '<img  src="Images/arrow2.png" class="arrow img-fluid">';
    count = 0;
  } else {
    ...
    document.querySelector("#show_more2").innerHTML =
      '<img  src="Images/arrow1.png" class="arrow img-fluid">';
    count = 1;
  }
});
